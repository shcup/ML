...
cat $dir/part* | awk -F "\t" '{
            ...
            if($3 == "Lifestyle,") {print "__label__1 , \t" $0}
            else if ($3 == "Auto," || $3 == "Autos") {print "__label__2 , \t" $0}
            else if ($3 == "Sports," || $3 == "Sport"){print "__label__3 , \t" $0}
            else if ($3 == "India,") {print "__label__4 , \t" $0}
            else if($3 == "Sci-Tech,") {print "__label__5 , \t" $0}
            else if($3 == "Business,") {print "__label__6 , \t" $0}
            else if($3 == "Education,") {print "__label__7 , \t" $0}
            else if($3 == "Entertainment,") {print "__label__8 , \t" $0}
            else if($3 == "World,") {print "__label__9 , \t" $0}
